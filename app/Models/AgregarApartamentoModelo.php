...
class AgregarApartamentoModelo extends Model
{
     function addApartamento($ciudad, $pais, $direccion, $ubicacionGoogleMap, $numeroAbitaciones, $imgApartamento, $imgDestacada, $valorNoche, $reseña){
        $sql = "INSERT INTO agregar (ciudad, pais, direccion, ubicacionGoogleMap, numeroAbitaciones, imgApartamento, imgDestacada, valorNoche, reseña) VALUES ('{$ciudad}', '{$pais}', '{$direccion}', '{$ubicacionGoogleMap}', '{$numeroAbitaciones}', '{$imgApartamento}' , '{$imgDestacada}', '{$valorNoche}', '{$reseña}')";
        $this->db->query($sql);
     ...
     function agregarEditar($id, $ciudad, $pais, $direccion, $ubicacionGoogleMap, $numeroAbitaciones, $imgApartamento, $imgDestacada, $valorNoche, $reseña){
